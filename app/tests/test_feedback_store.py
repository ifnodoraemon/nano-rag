...
def test_feedback_store_prunes_old_persisted_files(tmp_path) -> None:
    ...
    store.save_raw({"feedback_id": "fb-1", "trace_id": "trace-1", "rating": "up", "kb_id": "default", "created_at": 1.0})
    store.save_raw({"feedback_id": "fb-2", "trace_id": "trace-2", "rating": "up", "kb_id": "default", "created_at": 2.0})
    store.save_raw({"feedback_id": "fb-3", "trace_id": "trace-3", "rating": "up", "kb_id": "default", "created_at": 3.0})
